...
public class PressKey : MonoBehaviour {
	...
	void Update () {
		...
		if (finish_game ()==1)
			player1_marker.transform.localPosition = new Vector3 (-344 + 160 * healthBarSlider.value, 170f);
		//the coords of 344, 160, 170 depends on canvas size. ask Xi for detail 
		if (finish_game ()==2)
			player2_marker.transform.localPosition = new Vector3 (-344 + 160 * healthBarSlider.value,170f);
//		if (healthBarSlider.value == 0.8f) {
//			//gameObject.SetActive (true);
//			transform.localPosition = new Vector3 (-316 + 160 * healthBarSlider.value, 156.5f);
//		}
}
